package com.sidneyferreira.workshopmongo.config;
...
//        SE QUISER DATA DE HOJE USAR ESTE
//        Post post1 = new Post( null, sdf.parse(dataHoje), "Partiu viagem", "Vou viajar para São Paulo. Abraços!", maria);
//        Post post2 = new Post( null, sdf.parse(dataHoje), "Bom dia", "Acordei feliz hoje!", maria);
